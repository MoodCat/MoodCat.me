...
\newglossaryentry{KD-tree}{
 name = KD-tree,
 description={
 A data structure that organizes points in a space of k-dimensions.
 }
}
...
\newglossaryentry{LSH}{
  name = LSH,
  description={
 An algorithm for finding similar items in a high dimensional space.
  }
}

\newglossaryentry{R-tree}{
 name = R-Tree,
 description={
 A data structure that makes a tree according to similarity.
 }
}
...
When the backed is started, the backend retrieves rooms from the database and creates an instances for each of those.
The backend keeps track of a current song, a history of previously played songs and a playing queue for future tracks to play.

...
Default values will be determined by examining the audio features from our data set.
...
Furthermore each song has its own \gls{valence} and \gls{arousal} value, which is computed and corrected by the music matching algorithm.

...
&
\begin{enumerate}
\item This issue has taken up a lot of time. This is partly due to the fact we only guessed 4 hours, this should have been 4 hours per person. Also, we took the time because we have made some pretty big changes to our future planning. We will deviate from the neural network we planned, because getting enough training data would be a master thesis size project, according to Cynthia. We had a meeting with Cynthia on Tuesday, to strategize our planning. We agreed on dropping the neural network, and search for a simpler way of getting past a cold start. Most of the training will be delegated to users, possibly in a gamification manner.
